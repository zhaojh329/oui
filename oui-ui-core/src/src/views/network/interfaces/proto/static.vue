<template>
  <div v-if="proto === 'static'">
    ...
    <uci-option tab="general" type="input" :label="$t('IPv4 broadcast')" name="broadcast" :placeholder="broadcastPlaceholder" depend="proto == 'static'" rules="ip4addr"></uci-option>
...
export default {
  ...
  methods: {
    calculateBroadcast() {
      ...
      this.broadcastPlaceholder = '%d.%d.%d.%d'.format((B >> 24) & 0xFF, (B >> 16) & 0xFF, (B >> 8) & 0xFF, (B >> 0) & 0xFF);
    },
    ipChange(v) {
      this.ipaddr = v;
