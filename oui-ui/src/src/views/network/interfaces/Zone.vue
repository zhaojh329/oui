<template>
  <oui-form-item-select :uci-section="uciSection" :label="$t('Create / Assign firewall-zone')" name="_fwzone" :options="zones" :load="loadZone" :save="saveZone" allow-create :help="$t('interface-config-zone-desc')"/>
</template>
